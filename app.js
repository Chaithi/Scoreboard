...
import PropTypes from 'prop-types'; // Updated to work in React 15.5

var React = require('react');
var createReactClass = require('create-react-class');

const INITIAL_STATE = { // Removed initial players.
  players: [],
}
...
var Stopwatch = createReactClass({
  ...
  componentDidMount: function () {
    this.interval = setInterval(this.onTick, 100); // RT: Had to add , 100 to get to function in Firefox.
  },
